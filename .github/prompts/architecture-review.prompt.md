---
agent: ask
description: "Use when: executar o fluxo architecture-review no projeto de churn"
---
...
1. **Compare** a proposta com `.github/context/architecture.md` e `.github/context/tech-stack.md`.
...
- **Uso de IA:** `.github/rules/ai-usage-rules.md`
