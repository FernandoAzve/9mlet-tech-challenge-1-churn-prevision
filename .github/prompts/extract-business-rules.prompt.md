---
agent: ask
description: "Use when: executar o fluxo extract-business-rules no projeto de churn"
---
...
- Alinhar com `.github/rules/business-rules.md` e apontar conflitos se houver.
