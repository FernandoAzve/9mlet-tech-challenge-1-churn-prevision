---
agent: ask
description: "Use when: executar o fluxo test-strategy no projeto de churn"
---
...
- Compatível com `.github/rules/testing-rules.md`.
...
- **Regras de testes:** `.github/rules/testing-rules.md`
