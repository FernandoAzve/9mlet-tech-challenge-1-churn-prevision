---
agent: ask
description: "Use when: executar o fluxo generate-boilerplate no projeto de churn"
---
...
3. **Respeite** `.github/rules/code-style.md` e **ruff**.
4. **Use apenas** dependências de `.github/libs/allowed-libs.md`.
...
- **Estilo:** `.github/rules/code-style.md`
